...
public class IndexaUrlAction extends ActionSupport implements SessionAware {
    ...
    public String execute() throws Exception {
        if(this.link!=null && !link.equals("")){
            session.put("link", link);

        }
        result = getHeyBean().indexaUrl(this.link);
    ...
    public void setLink(String link) {
        this.link = link; // will you sanitize this input? maybe use a prepared statement?
    }
